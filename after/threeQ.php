...
if (isset($_POST['answer'])) {
  ...
  switch ($_POST['answer']) {
    case '1':
      $sql = "INSERT INTO a_answer2_1 (time) VALUES ('$time')";
      break;
    case '2':
      $sql = "INSERT INTO a_answer2_2 (time) VALUES ('$time')";
      break;
    case '3':
      $sql = "INSERT INTO a_answer2_3 (time) VALUES ('$time')";
      break;
    default:
      echo "";
      break;
...
<div class="quiz-container">
    ...
    <form action="./end.php" method="POST">
      <fieldset>
        <legend><?= htmlspecialchars($questions[2]['question']) ?></legend>
