...
$data = [
    ...
    'a_counts' => [ // Альтернативные счетчики
        'a_answer1_1' => $a_answer1_1,
        'a_answer1_2' => $a_answer1_2,
        'a_answer1_3' => $a_answer1_3,
        'a_answer2_1' => $a_answer2_1,
        'a_answer2_2' => $a_answer2_2,
        'a_answer2_3' => $a_answer2_3,
        'a_answer3_1' => $a_answer3_1,
        'a_answer3_2' => $a_answer3_2,
        'a_answer3_3' => $a_answer3_3,
    ],
    'percents' => [ // Основные проценты
        'p1_1' => $p1_1,
        'p1_2' => $p1_2,
        'p1_3' => $p1_3,
        'p2_1' => $p2_1,
    ...
    'a_percents' => [ // Альтернативные проценты
        'a_p1_1' => $a_p1_1,
        'a_p1_2' => $a_p1_2,
        'a_p1_3' => $a_p1_3,
        'a_p2_1' => $a_p2_1,
